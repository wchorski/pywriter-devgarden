#pictures #selfhosted
# [PhotoPrism](/vault/https://photoprism.app/)
Browse Your Life in Pictures

An open source, self hosted solution for services like [iCloud](/vault/https://www.icloud.com/) | [Google Photos](/vault/https://photos.google.com/). don't be afraid of the `compose.yml`. You'll only need to change a few things like `<username>`, `<passwordForAppLogin>`, `<strongpassword>` 

## connections


## installation
### [Docker](/vault/%F0%9F%93%81developer/Home__Lab__%F0%9F%8F%A0/Docker.md) build 
1. `compose.yml`
```
version: '3.5'
