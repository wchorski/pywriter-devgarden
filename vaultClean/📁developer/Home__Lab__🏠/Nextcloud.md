...
## [Homepage - Nextcloud](/vault/https://nextcloud.com/)
...
---
### connections
- publicly face app with [Nginx](/vault/Nginx__Proxy__Manager.md#Publicly__Facing__App)
- syncs pictures for [PhotoPrism](/vault/PhotoPrism.md) to read my every growing photo gallery
...
2. [Docker](/vault/Docker.md) `compose.yml`
```yaml
version: '2'
...
> via `config/config.php` [source](/vault/https://help.nextcloud.com/t/cant-start-nextcloud-because-the-version-of-the-data-is-higher-than-the-docker-image-version-and-downgrading-is-not-supported/109438/4)
...
> [source](/vault/https://help.nextcloud.com/t/cant-start-nextcloud-because-the-version-of-the-data-is-higher-than-the-docker-image-version-and-downgrading-is-not-supported/109438/4?u=wchorski)

If you don't make backups then you could possibly edit the container's `html/version.php`. Gotta thank [Duplicati](/vault/📁developer/Home__Lab__🏠/Duplicati.md) for saving my behind
